...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to phased "gobject list" output
    ...
    def phased_serialise(self):
        import phaselib
        return phaselib.SHIM_serialise_for_phased(self.serialise())
